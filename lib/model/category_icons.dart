    ...
    switch (categoryId.toLowerCase()) {
      case 'electronics':
        ...
        if (subLower.contains('appliance') ||
            subLower.contains('electrodoméstico')) return Icons.countertops;
      ...
      case 'home':
        ...
        if (subLower.contains('decoration') || subLower.contains('decoración'))
          return Icons.brush;
        ...
        if (subLower.contains('appliance') ||
            subLower.contains('electrodoméstico')) return Icons.blender;
        return Icons.chair;
