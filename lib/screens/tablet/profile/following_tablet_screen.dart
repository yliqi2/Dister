...
class FollowingTabletScreen extends StatefulWidget {
  final String title;
  final List<String> userIds;
  const FollowingTabletScreen({
    super.key,
    required this.title,
  ...
  @override
  State<FollowingTabletScreen> createState() => _FollowingTabletScreenState();
}

class _FollowingTabletScreenState extends State<FollowingTabletScreen> {
